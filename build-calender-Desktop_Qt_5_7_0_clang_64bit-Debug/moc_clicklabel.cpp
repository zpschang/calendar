...
QT_MOC_LITERAL(1, 11, 12), // "left_clicked"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 13) // "right_clicked"

    },
    "ClickLabel\0left_clicked\0\0right_clicked"
};
...
void ClickLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClickLabel::left_clicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ClickLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ClickLabel::right_clicked)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void ClickLabel::left_clicked()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void ClickLabel::right_clicked()
{
