...
QT_MOC_LITERAL(1, 10, 12), // "right_signal"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "DragLabel\0right_signal\0"
};
...
void DragLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DragLabel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DragLabel::right_signal)) {
                *result = 0;
                return;
            }
        }
